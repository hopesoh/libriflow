...
public class LibriFlowApplication {
    ...
    CommandLineRunner dataInitializer(BookRepository bookRepository, UserRepository userRepository) {
        return args -> {
            ...
            u1.setPassword("123456"); // texto puro no banco
            ...
            b4.setStock(0); // sem estoque - para testar validação
            bookRepository.save(b4);

            System.out.println("=== LibriFlow iniciado! Dados de teste carregados. ===");
            System.out.println("H2 Console: http://localhost:8080/h2-console");
            System.out.println("JDBC URL: jdbc:h2:mem:libriflow");
        };
    }
}
